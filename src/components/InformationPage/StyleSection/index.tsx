...
const cardsProps = [
	...
	},
	{
		title: 'Horror',
		description:
            'Jogos que buscam causar medo e suspense nos jogadores.'
	},
    {
		title: 'Comédia',
		description:
            'Jogos que buscam divertir os jogadores com humor.'
	},
	{
		title: 'Drama',
		description:
    ...
    return (
        <Flex
            ...
            <Text
                ...
                fontSize={'25px'}
                color={'white'}>
                Os jogos também podem ser divididos em diferentes estilos de design,<br /> que são definidos com base em sua estética, narrativa e jogabilidade.<br />Alguns dos estilos de design de jogos mais populares incluem:
            </Text>
